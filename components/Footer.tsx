...
const FooterColumn = ({ title, links }: ColomnProps) => (
        ...
        <footer className="flexStart flex-col lg:px-20 py-6 px-5 w-full gap-20 bg-light-white">
            <div className="flex flex-col gap-12 w-full">
                <div className="flex items-start flex-col">
                    ...
                    <p className='text-start text-sm font-normal mt-5 max-w-xs'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil voluptatum iure accusamus quidem maxime culpa qui nesciunt quis, quasi doloribus.</p>
                </div>
